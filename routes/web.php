...
use App\Http\Controllers\ChefDeProjet\DashboardController as ChefDashboardController;
...
use App\Http\Controllers\Developpeur\DashboardController as DevDashboardController;
...
Route::middleware(['auth'])->group(function () {
    ...
    // Redirection automatique centralisée selon le rôle utilisateur
    ...
    Route::middleware(['can:isDeveloppeur'])->prefix('dev')->name('dev.')->group(function () {
        ...
        Route::post('/tasks/{task}/timesheets', [DevTaskController::class, 'storeTimesheet'])->name('tasks.timesheets.store');
    });
